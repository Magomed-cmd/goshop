...
func (_m *MockOrderRepository) ClearCart(ctx context.Context, cartID int64) error {
...
// MockOrderRepository_ClearCart_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearCart'
type MockOrderRepository_ClearCart_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - cartID int64
func (_e *MockOrderRepository_Expecter) ClearCart(ctx interface{}, cartID interface{}) *MockOrderRepository_ClearCart_Call {
	return &MockOrderRepository_ClearCart_Call{Call: _e.mock.On("ClearCart", ctx, cartID)}
}

func (_c *MockOrderRepository_ClearCart_Call) Run(run func(ctx context.Context, cartID int64)) *MockOrderRepository_ClearCart_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockOrderRepository_ClearCart_Call) Return(_a0 error) *MockOrderRepository_ClearCart_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockOrderRepository_ClearCart_Call) RunAndReturn(run func(context.Context, int64) error) *MockOrderRepository_ClearCart_Call {
	_c.Call.Return(run)
	return _c
}

// CreateOrder provides a mock function with given fields: ctx, _a1
func (_m *MockOrderRepository) CreateOrder(ctx context.Context, _a1 *entities.Order) (*int, error) {
	...
	var r0 *int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *entities.Order) (*int, error)); ok {
		return rf(ctx, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *entities.Order) *int); ok {
		r0 = rf(ctx, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*int)
...
func (_c *MockOrderRepository_CreateOrder_Call) Return(_a0 *int, _a1 error) *MockOrderRepository_CreateOrder_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOrderRepository_CreateOrder_Call) RunAndReturn(run func(context.Context, *entities.Order) (*int, error)) *MockOrderRepository_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockOrderRepository) GetUserOrders(ctx context.Context, userID int) ([]*entities.Order, error) {
...
//   - ctx context.Context
//   - userID int
func (_e *MockOrderRepository_Expecter) GetUserOrders(ctx interface{}, userID interface{}) *MockOrderRepository_GetUserOrders_Call {
	return &MockOrderRepository_GetUserOrders_Call{Call: _e.mock.On("GetUserOrders", ctx, userID)}
}

func (_c *MockOrderRepository_GetUserOrders_Call) Run(run func(ctx context.Context, userID int)) *MockOrderRepository_GetUserOrders_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int))
	})
	return _c
...
func (_c *MockOrderRepository_GetUserOrders_Call) Return(_a0 []*entities.Order, _a1 error) *MockOrderRepository_GetUserOrders_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOrderRepository_GetUserOrders_Call) RunAndReturn(run func(context.Context, int) ([]*entities.Order, error)) *MockOrderRepository_GetUserOrders_Call {
	_c.Call.Return(run)
	return _c
}
